        ...
        class ExampleForm : Form
        {
            ...
            void InitializeComponent()
            {
                ...
                this.Controls.AddRange(new System.Windows.Forms.Control[] {
                    this.button23, this.button22, this.button21, this.button20,
                    this.button19, this.button18, this.button17, this.button16,
                    this.button15, this.button14, this.button13, this.button12,
                    this.button11, this.button10, this.button9,  this.button8,
                    this.button7,  this.button6,  this.button5,  this.button4,
                    this.button3,  this.button2,  this.button});
